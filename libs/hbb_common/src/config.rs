...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("ljg.xiaoliya.online".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("XiaoLiRemote".to_owned());
...
pub const RS_PUB_KEY: &str = "CBWNPW1XI+mKiMyixlSHBDPuoADnJmin3VdqSHXRTCo=";
